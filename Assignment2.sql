...
-- 3. Display firstName, lastName, and email of employees with jobTitle 'Sales Rep', ordered by employeeNumber DESC
...
-- 5. Fetch productName and quantityInStock from products table, ordered by buyPrice ASC, limit 5 records
